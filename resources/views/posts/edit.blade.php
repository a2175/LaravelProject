        ...
        <fieldset><legend>글작성</legend>
            ...
            <div class="table">
                <div class="tr">
                    ...
                    <div class="desc"><input type="text" id="board_name" name="name" size="20" title="작성자" value="{{ $post->name }}" required autofocus></div>
                </div>
                <div class="tr">
                ...
                <div class="tr">
                    ...
                    <div class="desc"><input type="text" id="board_subject" name="subject" size="80" title="제목" value="{{ $post->subject }}" required></div>
                </div>
                <div class="tr">
                    <div class="lbl"><label for="board_content">내용</label></div>
                    <div class="desc"><textarea id="board_content" name="content" cols="80" rows="10" title="내용" required>{{ $post->content }}</textarea></div>
                </div>
            </div>
            <div class="btn_group">
